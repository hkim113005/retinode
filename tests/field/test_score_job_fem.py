...
def test_a_tip_pillar_scores_and_differs_from_the_flat_disk():
    ...
    measurably different from a flat disk of the same footprint. That is the whole
    reason shaped electrodes are worth authoring. It penetrates the ~20 µm cell
    plane, so it needs the displace policy to sever the in-metal compartments."""
